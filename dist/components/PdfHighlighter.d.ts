...
import { PointerEventHandler, PureComponent, ReactNode, RefObject } from 'react';
...
interface Props<T_HT> {
    ...
    onSelectionFinished: (position: ScaledPosition, content: {
        text?: string;
        image?: string;
    }, hideTipAndSelection: () => void, transformSelection: () => void) => ReactNode;
...
export declare class PdfHighlighter<T_HT extends IHighlight> extends PureComponent<Props<T_HT>, State<T_HT>> {
    ...
    setTip(position: Position, inner: ReactNode): void;
